...
Number of possible policies is equal to number of actions to the power of number of states. In reinforcement learning, the model trains from interactions with its environment (reward), instead of labeled data.\textbf{}
