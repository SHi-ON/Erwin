...
class ChainWalkDomain(Domain):
    ...
    reward_location: ChainWalkDomain.RewardLoction
    ...
    def apply_action(self, action):
        ...
        reward = 0
        if self.reward_location == ChainWalkDomain.RewardLocation.Ends:
            if new_location == 0 or new_location == self.num_states - 1:
                reward = 1
        elif self.reward_location == ChainWalkDomain.RewardLocation.Middle:
    ...
    def reset(self, initial_state=None):
        ...
        if initial_state is None:
            self._state = ChainWalkDomain.__init_random_state(self.num_states)
        else:
    ...
    def action_name(self, action):
        ...
        """
        return ChainWalkDomain.__action_names[action]
